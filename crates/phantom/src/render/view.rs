...
impl WorldRender {
    pub fn new(gpu: &crate::render::gpu::Gpu, asset: &crate::asset::Asset) -> Self {
    ...
    pub fn render<'rp>(
        ...
        let (camera_position, projection, view) =
            crate::asset::create_camera_matrices(asset, scene, gpu.aspect_ratio());
        ...
        // TODO: Refactor this to first sort by material, then sort materials by alpha mode and crate::render Opaque, Mask, then Blend
        for alpha_mode in [
...
fn create_texture(gpu: &crate::render::gpu::Gpu, image: &crate::asset::Image) -> wgpu::Texture {
